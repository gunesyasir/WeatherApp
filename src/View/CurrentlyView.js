...
const CurrentlyView = (props) => {
    return (
        <View style={styles.currentlyView}>
            <Image source={IconUtils.iconPath(props.currentlyIcon)} style={{width:130,height:130}}/>
            <Text style={styles.currentlyData}>
                {TemperatureUnitConversion.fahrenheitToCelsius(props.currentlyTemperature)}{"\u2103"}
            </Text>
        </View>
    )
}
